...
function getGeneratedCodes() {
    ...
    $sql = mysqli_query($conn,
    "SELECT id,status,email,exam_key,exam_date, strand, pref_course,pref_secondary_course,pref_tertiary_course, interest, secondary_interest, tertiary_interest, hobby, secondary_hobby, tertiary_hobby ,exam_key_created_at
...
function getExamDates() {
    ...
    $sql = mysqli_query($conn,
    "SELECT id,exam_date,exam_time,exam_date_created
    FROM admin_schedule
    ");
    return mysqli_fetch_all($sql, MYSQLI_ASSOC);
}
