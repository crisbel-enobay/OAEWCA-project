          ...
          <div class="row quick-action-toolbar">
            <div class="col-md-12 grid-margin">
              <div class="card">
                  ...
                  <p class="lead mb-0 "><?php echo $_SESSION['topics_id'];?></p>
                  </div>
                ...
                <div class="card">
                  ...
                  <form class="forms-sample" method="POST">
                      ...
                      <div class="form-group row">
                        <label for="que_description" class="col-sm-3 col-form-label">Question</label>
                        <div class="col-sm-9">
                        <textarea placeholder="Question..." name="que_description" class="form-control" id="que_description" rows="5" cols="45" required>Questions...</textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="optA" class="col-sm-3 col-form-label">Option A</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="optA" value="option A">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="optB" class="col-sm-3 col-form-label">Option B</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="optB" value="option B">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="optC" class="col-sm-3 col-form-label">Option C</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="optC" value="option C">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="optD" class="col-sm-3 col-form-label">Option D</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="optD" value="option D">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="optD" class="col-sm-3 col-form-label">Correct Answer</label>
                        <div class="col-sm-9">
                      ...
                      <input type="submit" name='add' class="btn btn-info mr-2" value='Update'>
