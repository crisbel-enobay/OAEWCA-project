...
<<<<<<< Updated upstream:views/archived_hobbies.php
=======
    include "admin-checker.php";
   include '../file/logout-function.php';
>>>>>>> Stashed changes:views/admin-schedule.php
?>
<!DOCTYPE html>
<html lang="en">
  <head>
        ...
        <div class="content-wrapper">
          <div class="page-header">
            <nav>
              <ol class="breadcrumb">
<<<<<<< Updated upstream:views/archived_hobbies.php
                <li class="breadcrumb-item "><a href="../views/admin-hobbies.php">Hobbies List </a></li>
...
<<<<<<< Updated upstream:views/archived_hobbies.php
                    <h5 class="mb-0">Archived list - Hobbies</h5>
=======
                    ...
                    <form method="POST">
                      <div class="modal-body p-5">
                        <div class="mb-3">
                          ...
                          <input type="time" value="<?= date('h:i') ?>" name="time" id="schedule date"  class="form-control" required>
                        </div>
                      ...
                      <div class="modal-footer">
                        ...
                        <?php
                            ...
                            {
                                $inputDate = "".$_POST['date'].$_POST['time'];
                                $ExamDate = date('Y-m-d h:i', strtotime($inputDate));
