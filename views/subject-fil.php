            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link active" href="../views/subject-fil.php">Filipino</a></li>
          ...
          <div class="page-header">
            <nav>
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="../views/archived_fil.php">Archives</a></li>
              </ol>
            </nav>
          </div>
                    ...
                    <form method="POST">
                      ...
                      <div class="modal-footer">
                        ...
                        <?php
                          ...
                          "INSERT INTO filipino_questionnaire(question, optionA, optionB, optionC, optionD, correctAnswer) VALUES ('".$newQS."','".$newA."', '".$newB."', '".$newC."', '".$newD."', '".$newright."')
                          ");
                              echo "<script> window.location = 'subject-fil.php' </script>";
                          }
                        ?>
                      ...
                      <form method="POST">
                        ...
                        <div class="modal-footer">
                          ...
                          if ($conn->connect_error) {
                            ...
                            $sql = mysqli_query($conn,
                          "UPDATE filipino_questionnaire SET question='".$edtQuestion."', optionA='".$edtoptionA."', optionB='".$edtoptionB."', optionC='".$edtoptionC."', optionD='".$edtoptionD."', correctAnswer='".$edtrightoption."' WHERE id= ".$edtid."
                          ");
                              echo "<script> window.location = 'subject-fil.php' </script>";
                          }
                        ?>
                        ...
                        <div class="modal-footer">
                          ...
                          <?php
                            if (isset($_POST['Archive'])){
                              ...
                              $sql = mysqli_query($conn,
                              "DELETE FROM filipino_questionnaire WHERE id = ".$delid."
                              ");
                              echo "<script> window.location = 'subject-fil.php' </script>";
                              }
                          ?>
