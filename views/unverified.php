       ...
       <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <nav>
              <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../views/results.php">Results</a></li>
          ...
          <div class="row quick-action-toolbar">
            <div class="col-md-12 grid-margin">
              ...
              <div class="modal fade" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel" aria-hidden="true">
                ...
                <button type="submit" name="approve" class="btn btn-primary my-4 py-2 px-4" style="margin-left: 40%" data-bs-toggle="modal" data-bs-target="#transactionModal">approve selected students</button>
              </div>
                </div>
               </form>
              </div>
