      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item nav-category"><span class="nav-link">Other</span></li>
            <li class="nav-item">
                          ...
                          echo "<tr>
                            ...
                            "<div class='d-flex '>
                              <form method='POST' action='../forms/delete_bus.php'>
                                        <button type='button' id='editButton' class = 'btn btn-primary mx-3 editbtn' data-bs-toggle='modal' data-bs-target='#editmodal' data-ID='$id' data-question='$question' data-sub='$sub' data-type='$type' data-set='$set' data-date='$date' onClick='editCourse(this)'>EDIT</button>
                                      </form>" .
                  ...
                  <div class="modal-content">
                    ...
                    <form method="POST">
                      ...
                      <div class="modal-footer">
                        <input type="submit" name="newadd" class="btn btn-primary" id="btnAdd" value="Add"/>
                        <?php
                          ...
                          $sqlquestion = mysqli_query($conn,
                          "INSERT INTO questionnaire(question, test_subject, test_type, test_set, date_modified) VALUES ('".$newQS."','".$newsub."', '".$newtype."', '".$newset."', now())
                          ");

                          $find = "SELECT q_id from questionnaire where question = '".$newQS."'";
                          $search = mysqli_query($conn, $find);
                          $fetch = mysqli_fetch_assoc($search);
                          $newid = $fetch['q_id'];
                          
                          if ($newtype == 'Multiple Choice'){
                            $sqlansmc = mysqli_query($conn,
                          "INSERT INTO answerss_mc(a_id, question, date_modified) VALUES ('".$newid."', '".$newQS."', now())
                          ");
                          }
                          else if ($newtype == 'True/False'){
                            $sqlanstf = mysqli_query($conn,
                          "INSERT INTO answers_tf(a_id, question, date_modified) VALUES ('".$newid."', '".$newQS."', now())
                          ");
                          }
                              echo "<script> window.location = 'admin-questions.php' </script>";
                          }
                        ?>
                        ...
                        <div class="modal-footer">
                          ...
                          <?php
                            if (isset($_POST['Archive'])){
                              ...
                              $sql = mysqli_query($conn,
                              "DELETE FROM questionnaire WHERE q_id = ".$delid."
                              ");
                              echo "<script> window.location = 'admin-questions.php' </script>";
                              }
                          ?>
